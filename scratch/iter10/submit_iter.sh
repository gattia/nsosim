#!/bin/bash
# Submit the iter10 isolation test (Procrustes anchors enabled) via PYTHONPATH override.
set -e

WORKTREE=/dataNAS/people/aagatti/programming/nsosim/.claude/worktrees/wrap-fitter-robustness
SCRATCH=$WORKTREE/scratch/iter10
...
SCRIPT=$SCRATCH/isolate_build_joint_model_with_anchor.py
...
#SBATCH --job-name=wrap_fitter_iter10
